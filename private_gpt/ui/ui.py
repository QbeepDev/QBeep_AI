...
class PrivateGptUi:
                ...
                for index, source in enumerate(cur_sources, start=1):
                    if f"{source.file}-{source.page}" not in used_files:
                        sources_text += (
                            ...
                            # + f'<a href="{source.file}" target="_blank" rel="noopener noreferrer">  </a>\n'
    ...
    def _build_ui_blocks(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            with gr.Row():
                gr.HTML(f"<div class='logo'/><img src={logo_svg} alt=Qbeep GPT></div")
            ...
            with gr.Row():
                ...
                # gr.HTML(
                #     f"<div class='footer'><a class='footer-zylon-link' href='https://umen.ai/'>Maintained by Umendran <img class='footer-zylon-ico' src='{f_base64}' alt=Umendran></a></div>"
                # )
